...
/**
 * Si consulti la documentazione della interfaccia SubsequenceCombinerFactory,
 * che modella
 * una factory per SubsequenceCombiner, che a sua volta modella un trasformatore
 * da liste a
 * liste, che funziona spezzando la lista in input in vari pezzi, ottenendo un
 * elemento
...
public class Test {
	...
	public void testTripletsToSum() {
		...
		// Si isolano triple, e se ne fornisce la somma: una parte finale di 1 o 2
		// elementi è comunque sommata
	...
	public void testCumulativeToList() {
		...
		// Soglia 100: non appena la somma degli elementi trovati diventa >=100 (o c'è
		// fine lista)
